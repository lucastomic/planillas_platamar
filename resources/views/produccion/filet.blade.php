...
@section('form')
    <input type="hidden" name="seccion" value="filet">
    ...
    <label for="trozos">Trozos</label>
    <input type="number" autocomplete="off" step="0.01" name="trozos">
@endsection
